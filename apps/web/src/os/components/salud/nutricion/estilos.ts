...
export const btnPlus: CSSProperties = {
  ...
  width: 30, height: 30, cursor: 'pointer', flexShrink: 0, fontSize: 18, lineHeight: 1,
  boxShadow: 'var(--os-shadow-accent)',
};
export const pill = (activo: boolean): CSSProperties => ({
  display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 5,
  padding: '7px 14px', minHeight: 34, borderRadius: 'var(--os-r-full)',
  fontFamily: 'var(--os-font-display)', fontSize: 12, fontWeight: 700, letterSpacing: '0.01em',
...
export const sheet: CSSProperties = {
  ...
  boxShadow: 'var(--os-shadow-modal)', width: '100%', maxWidth: 560, maxHeight: '86vh',
  display: 'flex', flexDirection: 'column', overflow: 'hidden',
};
export const sheetBody: CSSProperties = { overflowY: 'auto', padding: '0.25rem 1rem 1.25rem' };
